...
def configure_providers():
    ...
    api_keys_to_check = ["OPENAI_API_KEY", "OPENROUTER_API_KEY", "GEMINI_API_KEY", "XAI_API_KEY", "MISTRAL_API_KEY", "CUSTOM_API_URL"]
    ...
    if mistral_key and mistral_key != "your_mistral_api_key_here":
        valid_providers.append("Mistral")
        has_native_apis = True
    ...
    if restrictions:
        ...
        provider_instances = {}
        provider_types_to_validate = [ProviderType.GOOGLE, ProviderType.OPENAI, ProviderType.XAI, ProviderType.MISTRAL, ProviderType.DIAL]
